...
Local user will contain all of your customization settings, access permissions, file locations, and many other user-specific data. There are also two other accounts that are present, the **guest**, and the **administrator**. **Both of these accounts are disabled by default**.
...
1. get-help PS command [-examples] - Displays basic help for a command with examples
1. get-help PS command [-detailed] - Displays detailed help for a command with examples
1. get-help PS command [-full] - Displays all help information for a command with examples in greater depth
...
1. File Services: SMB, NFS, and DFS
1. Web Services: FTP, HTTP, and HTTPS
1. Management: Group policy and Active Directory domain services control
